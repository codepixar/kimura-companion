...
class Kimura_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Kimura ] Social Links', 'kimura' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'kimura' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'kimura' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'kimura-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'kimura-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'kimura-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'kimura-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'kimura-companion'); ?></label>
...
} // Class kimura_social_links ends here


// Register and load the widget
function kimura_social_links_widget_load() {
	register_widget( 'Kimura_social_links' );
}
add_action( 'widgets_init', 'kimura_social_links_widget_load' );