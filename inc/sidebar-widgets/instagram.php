...
----------------------------------------*/
class kimura_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('kimura_instagram_photo',esc_html__('[ Kimura ] Intagram Photo','kimura-companion'),array(
			'description' => esc_html__('Kimura Instagram Photo Widget','kimura-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'kimura-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'kimura-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'kimura-companion'); ?></label>
...
if(!function_exists('kimura_instagram_widgets')):
	function kimura_instagram_widgets(){
		register_widget('kimura_instagram_photo');
	}
	add_action('widgets_init','kimura_instagram_widgets');
endif;
